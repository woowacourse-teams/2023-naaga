...
public class GameController {
    ...
    @PatchMapping("/{gameId}")
    public ResponseEntity<GameStatusResponse> updateGameStatus(@Auth final MemberCommand memberCommand, @PathVariable final Long gameId, @RequestBody final Position position) {
        return null;
    }
